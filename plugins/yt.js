  ...
  run: async (sock, message, args, { sender, contextInfo }) => {
    ...
    try {
      ...
      if (err.message.includes("410"))
        msg =
          "Error 410: YouTube ha bloqueado esta petición. Intenta con otro video o actualiza el bot.";
      if (err.message.includes("confirm your age"))
        msg = "Este video tiene restricción de edad y no puede ser descargado.";
